...
def gerar_query(ano, mes):
    """
    Gera a query completa e dinâmica para a Tabela 5, com a lógica de data corrigida
    e nomes de coluna padronizados para o Python.
    """
    ...
    WITH dados_contribuicao AS (
        ...
        where (NR_ANO_REF = {ano} AND NR_MES_REF = {mes}) OR (NR_ANO_REF = {ano_anterior_logico} AND NR_MES_REF = {mes_anterior_logico})
