WITH dados_detalhados AS (
    ...
    FROM (
        ...
        WHERE 1 = 1
			  ...
			  and ptc.tipo_contribuicao = 'NORMAL'
    ...
    WHERE 1=1
        AND NR_ANO_REF = 2025
        AND NR_MES_REF in (4)
		  and contribuicao = 'NORMAL'
)
SELECT 
    FORMAT(CONTRIBUICAO_PATROCINADOR, 'C', 'pt-BR') AS CONTRIB_PATROCINADOR,
    FORMAT(CONTRIBUICAO_PARTICIPANTE, 'C', 'pt-BR') AS CONTRIB_PARTICIPANTE
